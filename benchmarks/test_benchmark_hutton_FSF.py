...
Uses the Fourier Series Field (FSF) in the inverse workflow to test the new series field implementation.
...
def test_benchmark_02_inverse_hutton_FSF(benchmark, request):
...
def test_benchmark_03_predict_hutton_FSF(benchmark, request):
